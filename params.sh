...
export KUBECOST_TENANT2_POLICY_GROUP="${KUBECOST_TENANT2_POLICY_GROUP:=XXXXX-XXXXX-XXXXX}"
export KUBECOST_TENANT2_DOMAIN_NAME="${KUBECOST_TENANT2_DOMAIN_NAME:=default.example.ca}"
...
for patch in policy/patch-policy*; do
  ...
  yq w -i $patch '[3].value' ${KUBECOST_TENANT2_POLICY_GROUP}
done
